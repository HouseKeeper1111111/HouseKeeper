...
import com.example.myapplication.data.Reminder.Status
import com.example.myapplication.ui.EditReminderDialogActivity
import com.example.myapplication.util.AlarmManagerUtil
    ...
    sealed class ReminderAction {
        ...
        companion object {
            private const val EXTRA_STRING_ACTION =
                "com.example.myapplication.ReminderManager.extra.ACTION"
